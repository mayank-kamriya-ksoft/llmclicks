  ...
  <Layout>
    <section className="section-padding pt-28 md:pt-36 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <motion.div className="rounded-2xl border border-border bg-card p-8 mb-10" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="font-display text-xl font-bold mb-3 flex items-center gap-2"><Heart className="h-5 w-5" /> Our Story</h2>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            { icon: Users, title: "Team", desc: "A passionate team of SEO experts, AI researchers, and product engineers." },
          ].map((item, i) => (
            <motion.div key={item.title} className="rounded-2xl border border-border bg-card p-7 text-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
              <div className="mx-auto mb-4 h-12 w-12 rounded-xl bg-secondary flex items-center justify-center">
