...
const cards = [
  { icon: Eye, num: "01", title: "Pull back the lid on your AI presence", desc: "Keep tabs on brand presence, performance, and position across every LLM.", link: "/features/ai-visibility-audit" },
  { icon: MessageSquare, num: "02", title: "Track every prompt that mentions you", desc: "Monitor which prompts surface your brand and track changes over time.", link: "/features/ai-visibility-tracker" },
  { icon: Quote, num: "03", title: "See who's citing your content", desc: "Understand when and how LLMs cite your content in their responses.", link: "/features/on-page-optimizer" },
